...
const resumo = [
  { label: "Receita total", valor: "R$ 8.500,00", tipo: "positivo", icone: "↑" },
  { label: "Despesa total", valor: "R$ 5.230,00", tipo: "negativo", icone: "↓" },
  { label: "Saldo do mês", valor: "R$ 3.270,00", tipo: "positivo", icone: "=" },
...
const transacoes = [
  { data: "12/05", descricao: "Salário", categoria: "Receita", valor: "+ R$ 8.500,00", tipo: "positivo" },
  { data: "10/05", descricao: "Aluguel", categoria: "Moradia", valor: "- R$ 1.800,00", tipo: "negativo" },
  { data: "08/05", descricao: "Supermercado", categoria: "Alimentação", valor: "- R$ 620,00", tipo: "negativo" },
  { data: "07/05", descricao: "Aporte Tesouro", categoria: "Investimento", valor: "- R$ 1.000,00", tipo: "neutro" },
  { data: "05/05", descricao: "Restaurante", categoria: "Lazer", valor: "- R$ 180,00", tipo: "negativo" },
];
        ...
        <div className="relatorios__container">
          ...
          <header className="relatorios__header">
            <div>
              ...
              <p className="relatorios__subtitle">Visão completa das suas finanças em Maio de 2026</p>
            </div>
            <div className="relatorios__filtros">
              <button className="filtro filtro--ativo">Mês</button>
          ...
          <div className="painel painel--grafico">
            <div className="painel__header">
              ...
              <div className="legenda">
                <span className="legenda__item"><span className="legenda__cor legenda__cor--receita"></span>Receita</span>
                <span className="legenda__item"><span className="legenda__cor legenda__cor--despesa"></span>Despesa</span>
              </div>
            </div>
            <div className="grafico-barras">
              {meses.map((m) => (
                <div key={m.nome} className="grafico-barras__grupo">
                  <div className="grafico-barras__barras">
                    <div className="barra barra--receita" style={{ height: `${m.receita}%` }}></div>
                    <div className="barra barra--despesa" style={{ height: `${m.despesa}%` }}></div>
                  </div>
                  <span className="grafico-barras__label">{m.nome}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="painel-grid">
            ...
            <div className="painel">
              <div className="painel__header">
                ...
                <span className="painel__total">Total: R$ 5.230,00</span>
              </div>
                ...
                {categorias.map((c) => (
                  <li key={c.nome} className="categoria">
                    <div className="categoria__topo">
                      ...
                      <span className="categoria__valor">R$ {c.valor.toLocaleString("pt-BR")}</span>
                    </div>
                    <div className="categoria__barra">
                      <div className="categoria__preenchimento" style={{ width: `${c.percentual}%` }}></div>
                    </div>
            ...
            <div className="painel">
              <div className="painel__header">
                ...
                <a className="painel__link" href="#">Ver todas</a>
              </div>
              <ul className="transacoes">
                {transacoes.map((t, i) => (
                  <li key={i} className="transacao">
                    ...
                    <span className={`transacao__valor transacao__valor--${t.tipo}`}>{t.valor}</span>
                  </li>
                ))}
              </ul>
            </div>
